/*
  I choose this piece of code to demonstrate  my knowledge of C++. 
  Also this file solves the problem of detecting collision durin game,
  which I believe is related to the job I apply for. It shows my
  understanding of frame and SDL_surface.
*/
#include <vector>
#include <algorithm>
#include "ioManager.h"
...
/*
  Detect collison using strategy design pattern,
  decide which strategy to use during execution
*/
...
/*
  Detect collisoin by checking if two rectangular area overlap
*/
...
/*
  Detect collsion by measuring the distance between mid point of sprites
*/
...
/*
  This function handles transparency for both sprite
...
/*
  Detect collision by examing pixel by pixel
*/
